...
import com.example.movielist25.MovieContract.MovieEntry;

public class MovieProvider extends ContentProvider {
    private static final int MOVIE_LIST2 = 3;
    ...
    static {
        ...
        sUriMatcher.addURI(MovieContract.AUTHORITY, "list", MOVIE_LIST2);
    }

    MovieFavDBHelper DBHelper;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long _id2 = database.insert(MovieContractList.MovieEntry.TABLE_NAME, null, values);
        if (_id2 > 0) {
            returnUri = ContentUris.withAppendedId(MovieContract.CONTENT_URI, _id);
            getContext().getContentResolver().notifyChange(returnUri, null);
            return returnUri;
    ...
    public boolean onCreate() {
        DBHelper = new MovieFavDBHelper(getContext());
